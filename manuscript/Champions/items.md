...
Некоторые из этих предметов также покупают Melee AD Carry и брузеры. Они хорошо работают на мобильных чемпионах ближнего боя, благодаря высокому урону и эффектам на выживаемость.

Выбор предметов для AD Carry зависит от двух факторов:
...
| :---: | :---: | :---: | :---: |
| | | | |
| Урон от автоатак (критический урон) | DPS |  Yun Tal Wildarrows, Infinity Edge | Jinx, Zeri, Ashe |
| | | | |
| Урон от автоатак (on-hit урон) | DPS | BoRK, Guinsoo's Rageblade | Vayne, Kalista, Kog'Maw |
| | | | |
...
2. [**Kraken Slayer**](https://wiki.leagueoflegends.com/en-us/Kraken_Slayer) — собирают AD Carry с высокой скоростью атаки, которым нужна дополнительная мобильность. Она может понадобиться из-за ограничений самого чемпиона, сложившегося матчапа или для усиления мобильности от умений. Примеры: Kai'Sa, Ashe, Vayne. Kraken Slayer ситуативно берут Melee ADC и брузеры против squish композиций. Примеры: Yasuo, Bel'Veth, Viego, Irelia.
...
4. [**Yun Tal**](https://wiki.leagueoflegends.com/en-us/Yun_Tal_Wildarrows) — альтернатива Kraken Slayer для AD Carry,которым важно собрать высокий процент критического урона как можно раньше. Примеры: Jinx, Caitlyn, Tristana.
...
1. [**Navori Flickerblade**](https://wiki.leagueoflegends.com/en-us/Navori_Flickerblade) — продолжает сборки, которые начинаются с Essence Reaver. Позволяет чаще использовать умения чемпионам, для которых это основной источник урона. Примеры: Lucian, Sivir, Xayah.
...
// TODO: Некоторые предметы для AP carry также покупают AP брузеры и танки.
