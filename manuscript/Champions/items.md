...
Подготовка — это поиск, тестирование и запоминание билдов. Также важно знать условия, в которых они работают и не работают.

У каждого билда есть какая-то идея. Она заключается в синергии предметов, рун и умений чемпионов. Если идея билда не видна сразу, надо уточнить информацию о его компонентах и умениях чемпиона. Только поняв её, игрок сможет реализовать билд.
...
Эти сайты предлагают статистику билдов для каждого чемпиона. На них можно указать конкретный матчап. Тогда сайт выведет билды для выбранного оппонента. Самые популярные билды следует запомнить или записать. Такая подготовка будет самой эффективной для начинающих игроков.

Во-вторых, информацию предлагают сайты с гайдами для чемпионов. Эти гайды пишут опытные игроки. В них представлена очень подробная информация. Она касается не только билдов и матчапов, но также механик чемпиона и планов на разные стадии игры. Самый популярный из таких сайтов [mobafire.com](https://www.mobafire.com). Это хорошая отправная точка для новичка, который недавно начал играть ранговые партии и только знакомится со своим чемпионом.
...
Правильное исполнение билда — это не только выбор рун, заклинаний призывателя и покупка предметов в указанном порядке. Также это все решения игрока уровня микро и макро. Вот несколько примеров таких решений:
...
Планы на стадию лейнинга и игру определяют эти решения. Именно под них профессиональный игрок и оптимизировал свой билд. Другой игрок не сможет реализовать его, если будет следовать другим планам.
