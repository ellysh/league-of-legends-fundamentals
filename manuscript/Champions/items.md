...
2. **Предметы должны синергировать друг с другом**. Например, все предметы связки BoRK + Guinsoo's Rageblade + Wit's End имеют on-hit эффект. Он срабатывает чаще, благодаря эффекту Guinsoo's Rageblade. Такая связка даёт сильный power spike на каждом предмете.

3. **Предметы должны синергировать с рунами**. Например, связка на on-hit из прошлого примера дополняется руной Lethal Tempo. Она увеличивает скорость атаки и даёт ещё один on-hit эффект.
