...
3. [**Guardian Angel**](https://wiki.leagueoflegends.com/en-us/Guardian_Angel) — предмет для лейтгейма, когда смерть игрока может привести к поражению. Например, когда его чемпион — самый сильный в команде.
