...
Большинство предметов для брузеров дают AD и здоровье. Поэтому для этого класса основной способ улучшить выживаемость — собрать больше здоровья. У многих брузеров есть умение на щит и мобильность. Эти инструменты также позволяют дольше держаться в командных сражениях.

В завершении сборки брузеры берут один предмет на броню или на сопротивление магии. Это повышает эффективное здоровье чемпиона. Также это усиливает щит, если он есть. Завершать сборку может даже какой-то предмет для танков.
...
Идея начального предмета в том, чтобы дать чемпиону максимальный power spike. Для класса Bruiser это означает, что предмет должен давать AD, здоровье и сильный атакующий эффект.
...
2. [**Trinity Force**](https://wiki.leagueoflegends.com/en-us/Trinity_Force) — собирают чемпионы с умением типа модификатор атаки. Примеры: Jax, Camille, Wukong, Gnar, Fiora. Модификатор атаки хорошо сочетается с эффектом предмета. Вместо они дают большой burst урон.
...
4. [**Ravenous Hydra**](https://wiki.leagueoflegends.com/en-us/Ravenous_Hydra) — предмет покупают как начальный или транзитный, когда у чемпиона слабый wave clear. Примеры: Fiora, Camille, Tryndamere, Trundle. Без wave clear игрок не может выполнять fast push и proxy farming. Эти приёмы очень важны на верхней линии.
...
7. [**Blade of the Ruined King**](https://wiki.leagueoflegends.com/en-us/Blade_of_the_Ruined_King) — стандартный предмет для лёгких брузеров с умением на лечение и высокой скоростью атаки. Примеры: Irelia, Warwick, Briar. BoRK ситуативно берут брузеры с хорошей скоростью атаки, когда оппонент собирается в здоровье. Примеры: Jax, Sett, Trundle. BoRK усиливает дуэли на ранней стадии игры. Но дальше эффективность предмета сильно снижается.
...
8. [**Dead Man's Plate**](https://wiki.leagueoflegends.com/en-us/Dead_Man%27s_Plate) — предмет для тяжёлых брузеров, которым не хватает мобильности и брони. Обычно его покупают: Darius, Garen, Trundle, Volibear.
...
Билд саппорта имеет принципиальное отличие от других ролей. У саппортов есть специальный предмет, который примерно к 14 минуте бесплатно превращается в легендарный. Для этого надо выполнить квест на добивание миньонов и нанесение урона противнику. В результате саппорт первым в команде получает два легендарных предмета. Они дают ему сильный power spike.
