...
Нам осталось рассмотреть последнюю группу предметов, которая предназначена для класса Support. На самом деле, она охватывает лишь часть покупок типичного саппорта. Сборки для этого класса устроены сложнее остальных. Разберёмся, почему это так.

Согласно таблице 2-9, к саппортом относятся чемпионы разных классов. Их инструменты и билды кардинально отличаются. Таблица 5-12 демонстрирует типичные билды для разных классов саппортов.
...
Главное отличие билда у саппортов заключается в специальном предмете [**World Atlas**](https://wiki.leagueoflegends.com/en-us/World_Atlas). Игрок получает этот предмет автоматически на первой минуте. В начале мидгейма (около 14 минуты) World Atlas бесплатно превращается в легендарный предмет. Для этого надо выполнить квест на добивание миньонов и нанесение урона противнику. Также примерно в это же время саппорт покупает свой первый легендарный предмет. В результате он получает сильный power spike на двух предметах. Обычно его реализуют через роам и командное сражение на очередном объекте.
...
4. [**Ardent Censer**](https://wiki.leagueoflegends.com/en-us/Ardent_Censer) — собирают чемпионы класса Enchanter Support с умениями на усиление урона и на лечение или щит. Примеры: Lulu, Yuumi. Предмет усиливает защитное умение. Также после его применения владелец и цель получают дополнительную скорость атаки и on-hit урон. Ardent Censer хорошо работает, если в команде есть гиперкерри чемпион с основным уроном от автоатак.
...
2. [**Staff of Flowing Water**](https://wiki.leagueoflegends.com/en-us/Staff_of_Flowing_Water) — альтернатива Ardent Censer для чемпионов класса Enchanter Support. Примеры: Yuumi, Sona, Nami. Вместо скорости атаки и on-hit урона предмет даёт владельцу и цели дополнительное AP. Предмет эффективен, когда в команде есть несколько чемпионов класса AP Carry или гиперкерри, который скейлится от AP.
...
4. [**Trailblazer**](https://wiki.leagueoflegends.com/en-us/Trailblazer) — собирают саппорты танки ближнего боя против мобильных оппонентов. Примеры: Maokai, Alistar, Blitzcrank. Эффект предмета даёт дополнительную скорость владельцу и его союзникам. Также автоатаки владельца периодически замедляют цель.
