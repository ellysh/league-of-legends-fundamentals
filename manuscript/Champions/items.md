...
Начнём с предметов для класса AD Carry. Их демонстрирует таблица 5-6.

{caption: "Таблица 5-6. Предметы для класса AD Carry", width: "100%"}
...
Рассмотрим предметы для класса AP Carry. Как и предметы для AD Carry они делятся на три основные категории: начальные, транзитные, завершающие. Их демонстрирует таблица 5-7.

{caption: "Таблица 5-7. Предметы для класса AP Carry", width: "100%"}
...
Теперь поговорим о предметах для класса Tank на ролях топлейнер и лес. Как и предметы для других классов они делятся на начальные, транзитные и завершающие. Их демонстрирует таблица 5-8.

{caption: "Таблица 5-8. Предметы для класса Tank", width: "100%"}
...
Таблица 5-9 демонстрирует предметы для класса Assassin.

{caption: "Таблица 5-9. Предметы для класса Assassin", width: "100%"}
...
Таблица 5-10 демонстрирует предметы для класса Bruiser.

{caption: "Таблица 5-10. Предметы для класса Bruiser", width: "100%"}
