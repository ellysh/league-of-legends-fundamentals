...
На стадии драфта игрок выбирает два заклинания призывателя из девяти доступных. Обычно во время партии их нельзя заменить. Это позволяют только руны Unsealed Spellbook и Hextech Flashtraption.
...
2. [**Smite**](https://wiki.leagueoflegends.com/en-us/Smite) (кара) — наносит 600 true урона по лесному монстру или вражескому миньону. Может быть усилено при определённых условиях. Усиленную версию можно применять по противнику. Она наносит небольшой урон и замедляет цель.

3. [**Ignite**](https://wiki.leagueoflegends.com/en-us/Ignite) (воспламенение) — наносит противнику true урон в течение 5 секунд. Всё это время цель видна и получает штраф на восстановление здоровья.
...
3. [**Teleport**](https://wiki.leagueoflegends.com/en-us/Teleport) (телепорт) — после 3-х секундной подготовки перемещает чемпиона игрока к союзной башне, миньону или варду. Время в пути зависит от расстояния до цели. Заклинание улучшается на 10 минуте и работает быстрее.
...
Первый фактор важнее. Поэтому у каждой роли есть типичные пары заклинаний:
...
I> Типичные пары заклинания зависят от баланса текущего патча. В патче 14.24 ослабили заклинание ghost, поэтому для большинства ADC стало выгоднее брать barrier. Это может измениться в следующих патчах.

Разберёмся, этот список выглядит именно так. Начнём с заклинания flash. Его берут на каждой роли из-за универсальности. Flash позволяет преодолевать стены любой толщины, уклоняться от умений противника, сокращать или разрывать с ним дистанцию. Готовое заклинание даёт значительное преимущество в дуэли и командном сражении. Поэтому оно подходит большинству чемпионов.

Теперь пройдём по каждой роли. Обычно **топлейн и мидлейн** в дополнение к fash берут teleport. Он позволяет:
...
У заклинания teleport есть несколько альтернатив. Если чемпион ориентирован на snowball, ему нужно играть агрессивно. Тогда игрок берёт заклинание ignite и тем самым усиливает свой all-in. Также ignite хорошо работает в матчапах против чемпионов с умениями на восстановление здоровья.

Некоторым чемпионам для верхней линии очень важно позиционирование. Без дополнительной мобильности они не могут реализовать свой урон. Для таких чемпионов игроки заменяют teleport или flash на ghost. Например, teleport на ghost меняют: Darius, Olaf, Tryndamere, Vladimir. Flash на ghost меняют: Nasus, Dr.Mundo, Gwen.
...
Вторым заклинанием лесники обычно берут flash из-за его универсальности. Есть несколько чемпионов, которые скейлятся от скорости передвижения. Они обычно выбирают ghost вместо flash. Примеры: Hecarim и Rammus. Также есть чемпионы с высокой мобильностью, которым не нужен flash. Они берут вторым заклинанием ignite. Примеры: Shacko, Talon.

Следующая роль — **ADC**. У большинства чемпионов на этой роли слабая выживаемость. Этот недостаток игроки компенсируют заклинаниями призывателя.

Flash — это самый эффективный инструмент для отступления. Поэтому его берут на всех ADC чемпионах. Второе заклинание зависит от текущего баланса. Сейчас barrier эффективнее, чем альтернативные защитные заклинания. Раньше игроки выбирали между ghost и heal. Они были сильнее и давали больше преимуществ.

Игроки на роли ADC иногда меняют заклинание barrier в специфических матчапах. Когда у противника есть сильное умение на контроль, выгоднее брать заклинание cleans. Например, против Ashe и Varus. Если вражеский ADC имеет сильный all-in, его можно останавливать заклинанием exhaust. Например, его берут против Tristana и Samira.

Последняя роль — **саппорт**. Все чемпионы этой роли берут заклинание flash из-за его универсальности. Второе заклинание зависит от класса чемпиона и его инструментов. Агрессивные саппорты предпочитают ignite. Он увеличивает шансы на убийство в сражениях (skirmish) на нижней линии. Саппорты, ориентированные на защиту, берут heal. Он хорошо комбинируется с их умениями, предметами и рунами. Если у вражеского ADC сильный all-in, саппорт может взять exhaust. Тогда его ADC сможет играть с barrier или другим защитным заклинанием.
