...
Выбор чемпиона имеет решающее значение как для отдельно взятой партии, так и для динамики рейтинга игрока.
...
Другой пример. Начинающий игрок с низким уровнем Эло столкнулся с losing streak. Его причинами могут быть слабые пики и билды. Чтобы выйти из losing streak и поднять процент побед, игроку достаточно выбирать других чемпионов, руны, заклинания призывателя и предметы.
