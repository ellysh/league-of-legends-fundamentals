...
2. **Скейлинг в лейтгейм** (late game scaling). В команде есть минимум один гиперкерри чемпион. Примеры: Kayle, Jinx, Smolder, Aurelion Sol. Он слаб в начале партии, но становится очень сильным в лейтгейме. План заключается в замедлении игры и получении с карты равных ресурсов с противником. Те же ресурсы дают гиперкерри намного более сильные power spike, чем другим чемпионам. Тогда в мидгейме он начинает доминировать в командных сражениях. Игра всей команды строится вокруг гиперкерри.

I> **Scaling** (скейлинг или масштабирование) — это увеличение силы чемпиона в результате получения им ресурсов и с течением игрового времени.
