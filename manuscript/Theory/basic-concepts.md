...
Накопление преимущества начинается, когда одна из форм равновесия нарушается в пользу игрока. Он должен это заметить и суметь воспользоваться открывшейся возможностью. Часто это означает действовать по плану, в котором каждое действие даёт небольшую выгоду. Постепенно план приводит к крупному преимуществу. [**Темп**](https://leagueoflegends.fandom.com/wiki/Snowball#Qualities) — это то, с чего начинают накапливать преимущество опытные игроки. Разберёмся, что это означает.
...
League of Legends — это игра в реальном времени. Её механика не ограничивает моменты, когда игроки могут действовать. Тем не менее, в игре есть понятия хода и очередность хода.

I> **Плэй** (play) — так называют ход команды или чемпиона опытные игроки в League of Legends.

Команда и каждый отдельный чемпион эффективно действуют только при определённых условиях. Их готовность зависит от текущих ресурсов. Если ресурсы истощены, команда или чемпион действовать не могут.

Концепция темпа напрямую связана с ресурсами. Её подробно объясняет 
coach Kairos в [следующем видео](https://www.youtube.com/watch?v=vHVeltI0IkE). Он даёт следующую **формулу расчёта темпа** для конкретного чемпиона:
...
**Первая часть формулы** — сила чемпиона. Она складывается из его ресурсов. Для удобства разделим их на два типа:
...
Для простоты coach Kairos предлагает учитывать ресурсы чемпиона из таблицы 2-1.
...
| --- | --- | --- |
|  | | |
| resources | Здоровье и мана | 1 до 3, 2 — половина |
|  | | |
| stats | Базовые характеристики за уровень | от 1 до 5, 3 — равенство уровней |
|  | | |
| items | Предметы и их характеристики | от 1 до 5, 3 — равенство предметов |
|  | | |
| cooldowns | Готовность умений, заклинаний призывателя и эффектов предметов | от 1 до 5, 3 — некоторые CD готовы |
...
Обратите внимание, что resources — это множитель. Другими словами, здоровье и мана — определяющий фактор. На низком уровне здоровья у чемпиона нет темпа, независимо от остальных его характеристик.

**Вторая часть формулы** — расстояние до объекта. Это не только эпический монстр или вражеское строение. В контексте темпа им может быть линия для ганга, командное сражение или лагерь лесных монстров.

Обратите внимание, что темп считается для конкретного объекта на карте. Например, пусть чемпион находится на нижней линии. Тогда его темп относительно дракона будет высоким, а относительно барона — низким.
...
Чтобы оценить расстояние было проще, coach Kairos предлагает шкалу от 1 до 10:

* 1 — чемпион уже на объекте.
* 5 — чемпион на полпути к объекту.
* 10 — чемпион на базе или мёртв.

Рассмотрим, как использовать формулу на примере. Рассчитаем темп синего лесника Viego относительно дракона.

Допустим, что чемпион имеет полный уровень здоровья и маны. Тогда его resources равны 3. У него восьмой уровень, а у красного лесника — шестой. Тогда stats Viego равны 5. Пусть он собрал первый предмет, а противник — нет. Тогда его items равно 4. Все умения и заклинания у Viego готовы. Поэтому его cooldowns равны 5. Чемпион находится на нижней реке около логова дракона.

Расчёт темпа Viego выглядит так: 
{line-numbers: false, format: text}
```
tempo = 3 * (5 + 4 + 5) / 2 = 21
```

Это очень высокое значение. Сравним его с темпом красного лесника Ekko, который находится в своём верхнем лесу. Пусть у него полное здоровье и мана, шестой уровень, нет первого предмета и готовы все умения и заклинания.
...
Это очень низкое значение. Оно означает, что Ekko не может сейчас контестить дракона.

Формула для расчёта темпа указывает, как можно его увеличить. Для этого надо получить:
...
Этот список работает и в обратную сторону. Если что-то из перечисленного есть у противника, то игрок теряет темп.
...
Чтобы получить преимущество по темпу, игроку достаточно занять более выгодную позицию на карте, которая ближе к объекту. Поэтому его относительно просто получить. С другой стороны, это не гарантирует победы в дуэли или командном сражении. Это только небольшое преимущество над оппонентом. Но именно с него начинают опытные игроки.
