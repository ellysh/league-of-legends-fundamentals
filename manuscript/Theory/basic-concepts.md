...
Задача каждого игрока заключается в том, чтобы выбрать и исполнить самое выгодное макро действие. Оно должно нарушать равновесие любого типа в пользу команды игрока. Это повышает её шансы на победу.

### 2.1.3 Сценарий партии

Мы рассмотрели действия игроков. Важно понять, что они происходят в жёстких рамках. Их диктует дизайн и баланс самой игры. Разработчики хотят, чтобы каждая партия протекала по определённому сценарию. Поэтому они подбирают параметры игровых объектов так, чтобы игрокам было выгодно этому сценарию следовать.
...
Преимущество бывает разного типа. Это зависит от того, какая из форм равновесия была нарушена. Вот подробный список того, на какие типы преимущества ориентируются опытные игрок:
...
Реализация преимущества — это самое выгодное действие в общем случае. Причина в том, что преимущество уже есть. Оно повышает шансы на успешный результат действия. Пример: атака противников, когда у команды есть численное преимущество.
...
С другой стороны, красная команда проиграла сражение. Некоторые её чемпионы погибли, а другие получили значительный урон. Через некоторое время равновесие сил восстановится: здоровье пополнится, а убитые возродятся.

Теперь предположим, что после сражения на драконе красная команда вернулась на базу, а синяя — нет. Тогда красные восстановят свои ресурсы быстрее и получат преимущество. Несмотря на недавнее поражение, они готовы действовать, а противник — нет. Если красной команде удастся навязать новое сражение, они победят истощённых чемпионов синей команды. В этом и состоит понятие **очерёдности хода**:
