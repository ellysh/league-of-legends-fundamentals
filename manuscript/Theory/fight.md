...
Если команда решает преследовать противника, прежде всего она должна решить задачу **разведки**. Отступающие покидают место сражения, поэтому они оказываются вне видимости вардов на объекте. Преследователи должны проводить разведку на расстоянии. Средства для этого мы уже рассмотрели в разделе "2.3.5.1 Подготовка".

Когда цель обнаружена или известно её направление, преследователи должны её **добить**. С этой задачей хорошо справляются мобильные чемпионы. Также хороший инструмент для добивания — дальнобойные и глобальные умения. Они позволяют наносить урон противникам на большом расстоянии и в некоторых случаях даже без видимости.
