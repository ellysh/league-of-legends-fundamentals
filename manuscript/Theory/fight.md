...
Таблица 2-6 приводит эти параметры для каждого класса чемпионов.
...
* **Чемпион на poke** не должен терять время на стадии подготовки. Его задача — постоянно наносить урон противнику с безопасной дистанции. Если чемпион этого не делает, он не реализует свой урон.

* **Чемпиона на flanking** должен заранее занять позицию вне области видимости противника. Ему незачем участвовать в построении frontline. Там он не сможет эффективно реализовать свои инструменты.
...
Идеальный момент для применения ключевых умений наступает тогда, когда противник ошибается. Вот несколько примеров таких ошибок:
