...
Рассмотрим зависимость между параметрами команды и выгодным ей темпом сражения. Эту зависимость демонстрирует таблица 2-10

{caption: "Таблица 2-10. Параметры команды и темп сражения", width: "100%"}
