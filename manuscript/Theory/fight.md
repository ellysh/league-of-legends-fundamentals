...
Третья стадия сражения — **столкновение**. Цель команды на неё — реализовать свой урон и выиграть размен по убийствам. Эта цель достигается решением следующих задач:

1. Выигрыш времени для команды.
2. Нанесение урона.
3. Атака с фланга (flanking)

Стадия начинается, когда сталкиваются frontline обеих команд. С этого момента каждая сторона стремится реализовать преимущество, полученное при подготовке и инициации. Если на предыдущих стадиях противник уже получил значительное преимущество, команде выгоднее уклониться от сражения и отступить.

Во время сражения команде важно **выигрывать время**, чтобы её carry чемпионы могли наносить урон. Эту задачу решают чемпионы как frontline, так и backline. Главные инструменты для этого: умения контроля, лечения, усиления и щиты.

Чтобы выигрывать время для команды, подходят чемпионы следующих классов:
...
Пока одни чемпионы выигрывают время, carry команды должны **наносить урон** по противнику. Лучше всего с этим справляются чемпионы с сильной автоатакой или атакующими умениями. Обычно они немобильны и играют по плану front-to-back.
