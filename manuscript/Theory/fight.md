...
// TODO: Во время сражения нет времени думать. Игрок часто принимает решение интуитивно. При просмотре реплея есть возможность поставить паузу и обдумать сложившуюся ситуацию. Игрок должен найти для неё правильное действие и запомнить как шаблон.

// TODO: Именно так развивается навык быстрого принятия решений.
