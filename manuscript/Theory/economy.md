...
{caption: "Таблица 2-1. Стоимость по золоту волны миньонов", width: "70%"}
...
{caption: "Таблица 2-2. Награда опытом за миньонов", width: "80%"}
...
{caption: "Таблица 2-3. Опыт для получения чемпионом уровня", width: "80%"}
...
{caption: "Таблица 2-4. Опыт для получения лесником уровня", width: "85%"}
