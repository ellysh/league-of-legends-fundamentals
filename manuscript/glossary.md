...
**Mark** (отмечать) — это приём против flanking. Его идея в том, чтобы давать обзор на противника в засаде и вытеснять (zoning) его из сражения. Тогда он не сможет атаковать союзный backline.
...
**Pattern** (шаблон, образ) — общая закономерность в наблюдаемом окружении.

**Pick** (пик) — так называется выбор игроком конкретного чемпиона на стадии драфта.

**Play** (плей) — отдельное действие команды или игрока, которое преследует одну конкретную цель. Например, взятие эпического монстра или разрушение вражеской башни.
...
**Template** (шаблон) в терминологии CHREST — это когнитивная структура, которая отражает восприятие человеком окружающей среды. Структура представляет собой группу связанных между собой блоков (chunk).
