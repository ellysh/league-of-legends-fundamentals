...
**Контрпик** (counter pick) — игрок выбирает чемпиона, который из-за своей механики намного сильнее чемпиона противника. Контрпиком также называют самого чемпиона, который сильнее данного.
...
**Пушинг миньонов** ([pushing](https://www.mobafire.com/league-of-legends/wiki/game-mechanics/pushing)) — это быстрое убийство вражеских миньонов на линии. Для этого обычно применяются атакующие умения чемпионов.
...
**Back-to-front** (дословно "сзади-вперёд") — способ действия в сражении чемпиона или всей команды. Сражение начинается с атаки вражеского backline. Когда он погибает, чемпион или команда нападает на оставшийся frontline противника.

**Build** (билд или сборка) — это набор рун и строгий порядок покупки предметов, который игрок выбирает для своего чемпиона.
...
[**Champion mastery**](https://leagueoflegends.fandom.com/wiki/Champion_Mastery) (мастерство чемпиона) — это внутриигровая система прогресса, которая отслеживает опыт и исполнение игрока на каждом чемпионе.

**Champion pool** (пул чемпионов) — это набор чемпионов для одной роли. Игрок выбирает чемпиона только из этого набора в каждой ранговой партии.

**Contest** (контест) — это сражение команд за конкретный объект на карте: строение или эпического монстра.

[**Cooldown**](https://leagueoflegends.fandom.com/wiki/Cooldown) ([**перезарядка**](https://leagueoflegends.fandom.com/ru/wiki/Перезарядка)) наступает сразу после использования умения. Это время, в течении которого оно недоступно. Перезарядка есть не только у умений чемпиона, но и у рун, заклинаний призывателя и эффектов предметов.
...
**Execute** (казнить) — смерть игрока, в которой не участвует ни один вражеский чемпион. Таким образом никто из противников не получает награду золотом за убийство игрока. Самый эффективный способ исполнить execute — зайти в зону влияния вражеской башни и получить от неё урон.

### F

**Facecheck** (проверка лицом) означает зайти в кусты или другую область карты, в которой нет видимости. Это опасный приём, потому что в кустах враг может устроить засаду.

**Focus** или фокусить цель означает сконцентрировать на ней все атакующие возможности отдельного игрока или всей команды.

**Front-to-back** (дословно "спереди-назад") — способ действия в сражении чемпиона или всей команды. Сначала атакуется вражеский frontline. Когда он погибает, чемпион или команда нападает на открывшийся backline. 
...
**Map objective** (объект на карте) — эпический лесной монстр или вражеское строение. Их уничтожение увеличивает силу команды или даёт значительную награду. К объектам относятся: драконы, Геральд, барон Нашор, voidgrubs, вражеские башни и ингибиторы.

**Matching** (мэтчить) — означает, что чемпион одной команды может стоять на боковой линии против чемпиона другой команды на равных. При этом он способен остановить вражеский push и при этом не умереть.
...
**Most efficient tactic available** или META (самая эффективная из доступных тактик) означает стратегии, чемпионов и их сборки, которые считаются самыми эффективными в текущей версии игры.
...
**Roam** (роам) — игрок временно покидает свою линию, чтобы совершить ганг или оказать иное давление на противников.
...
**Snowball** (снежный ком или сноубол) — ситуация, когда чемпион или команда получает преимущество. После этого они его наращивают и становятся всё сильнее.
