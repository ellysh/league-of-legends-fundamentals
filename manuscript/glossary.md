...
**Focus** или зафокусить цель означает сконцентрировать на ней все атакующие возможности отдельного игрока или всей команды.
...
**Trade** (трейд) — это обмен уроном между чемпионами разных команд. Обычно он происходит на линиях на стадии лейнинга. Во время трейда каждая сторона стремится нанести противнику больше урона, чем получить в ответ. Такой трейд считается успешным и даёт победителю преимущество по динамическим ресурсам.
