...
[**Gold efficiency**](https://wiki.leagueoflegends.com/en-us/Gold_efficiency) (эффективность по золоту) — соотношение цены предмета к его характеристикам. Используется для сравнения теоретической полезности предметов. Эффективность по золоту можно так же рассчитать для рун, чтобы сравнить их полезность.
...
**Scaling** (скейлинг или масштабирование) — это увеличение силы чемпиона в результате получения им ресурсов и с течением игрового времени.
