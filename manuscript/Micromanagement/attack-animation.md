...
На вкладке "HOTKEYS" нажмите кнопку "Quick Cast All". Тогда чемпион будет применять умения, как только вы отпускаете соответствующую кнопку (например, W). Вам больше не нужны двойные нажатия. Это значительно ускоряет действия игрока, но к этой настройке надо привыкнуть.

Обратите внимание, что некоторые умения с [**зарядкой**](https://leagueoflegends.fandom.com/ru/wiki/Подготовка) (charging) не стоит настраивать на Quick Cast. Это касается умений, во время зарядки которых чемпион может двигаться. Тогда в это время можно применить заклинание призывателя [скачок](https://leagueoflegends.fandom.com/ru/wiki/Скачок_(заклинание_призывателя)) (flash). Зажимать клавишу умения с Quick Cast и одновременно использовать скачок неудобно. Легче нажать кнопку умения один раз, затем использовать скачок и потом нажать кнопку умения второй раз. Вот примеры умений с зарядкой, во время которой возможно движение: Vi Q, Viego W.

Тренируйте приём attack ability в "Practice tool". Постарайтесь запомнить область действия всех умений вашего основного чемпиона. Тогда вы не будете терять время и зажимать кнопку умения, чтобы проверить его радиус.
