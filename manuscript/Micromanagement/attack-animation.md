...
Работа с анимацией — это сложная, но важная тема. Чтобы её освоить нужны время и регулярные тренировки. Если игрок не умеет работать с анимацией, он не сможет делать следующие вещи:
