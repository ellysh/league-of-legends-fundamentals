...
На отрезках A-B и B-C происходит то же самое, что и на иллюстрации 3-1. Чемпион должен выполнить атаку, а для этого надо проиграть фазы windup и firing.

Иллюстрация 3-5 приводит случай, когда игрок применяет умение W на отрезке B-C или в точке C. Тогда чемпион начинает выполнять анимацию умения сразу после завершения фазы firing. Это происходит на отрезке C-D и далее.

В точке D закончится таймер перезарядки автоатаки. Если к этому моменту закончится анимация умения, игрок может дать команду на следующую атаку.
...
### 3.1.4 Исполнение приёма атака и умение
