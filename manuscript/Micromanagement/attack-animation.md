...
Эта горячая клавиша даёт команду на атаку. Назначьте для этого клавишу A. Тогда каждый раз при нажатии A чемпион будет атаковать ближайшую к нему цель.
...
3. Когда чемпион перейдёт в фазу firing или recovery, нажмите правую кнопку мыши. Чемпион начнёт двигаться в указанную точку. Это должно быть движение на противника или от него.

4. Считайте в уме таймер перезарядки автоатаки. Когда он закончится, начните следующую атаку с шага 1.
