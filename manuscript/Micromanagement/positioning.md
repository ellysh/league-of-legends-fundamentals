...
Чтобы лучше понять причину ошибки, остановите реплей в ключевой момент сражения или дуэли. Постарайтесь визуализировать важные зоны на экране. Для этого можно использовать инструмент для рисования [Epic Pen](https://epicpen.com).

После визуализации важных зон, найдите свою правильную позицию в данной игровой ситуации. Сравните её с реальной. Подумайте, почему вы ошиблись и какие факторы не учли.

Результат анализа сохраните в файл. Он послужит хорошим визуальным шаблоном. Регулярно просматривайте такие файлы, чтобы быстрее запоминать шаблоны.
