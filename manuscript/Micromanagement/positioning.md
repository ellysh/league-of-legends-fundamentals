...
Запомните, как выглядят зоны с этими тремя радиусами. Все остальные зоны можно представлять, отталкиваясь от них: чуть больше или чуть меньше.
...
Если разнести умения своего чемпиона и противника по этим категориям, будет легче оценивать их готовность во время лейнинга.
...
Если у игрока нет мэйна, у него нет эталона для сравнения параметров.
