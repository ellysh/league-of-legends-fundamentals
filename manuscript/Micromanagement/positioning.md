...
В игре есть функция подсветки радиусов умений и АА чемпиона игрока. Её можно использовать как подсказку для оценки расстояний на глаз.
...
Как можно использовать подсветку умения Caitlyn E? Дальность его действия составляет 800. Это немного больше дальности атаки башни 750. Игрок может ориентироваться на дальность умения, когда оценивает радиус влияния ближайшей башни.

Горячая клавиша для действия "Player Attack Move" показывает дальность АА чемпиона. По умолчанию это клавиша A. Иллюстрация 3-49 демонстрирует меню её настройки.
...
Дальность базовой атаки Caitlyn равна 650. Это почти в два раза меньше, чем радиус зоны получения опыта за миньонов 1500. Его можно примерно оценить, если подсветить дальность АА и мысленно увеличить её в два раза.
