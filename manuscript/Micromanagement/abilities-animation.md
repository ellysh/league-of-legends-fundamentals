...
1. [**Kayn Q**](https://www.youtube.com/watch?v=4Num03szneM). После рывка чемпион наносит второй удар косой. Если сократить фазу firing, уменьшится задержка между первым и вторым ударами.

2. **Lucian E**. Если сократить фазу firing, можно быстрее выполнить АА, которую усиливает пассивное умение чемпиона.
