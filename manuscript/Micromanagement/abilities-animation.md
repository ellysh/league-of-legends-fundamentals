...
1. Два статических умения
2. Статическое умение и flash.

Теперь рассмотрим третий способ маскировки анимации: статическое и динамическое умение. Цели такого приёма следующие:
...
**Статическое медленное умение Caitlyn Q** похоже на Ezreal Q. Дальность Caitlyn Q немного больше, но его фаза windup почти в три раза длиннее. Из-за этого направление снаряда легко предсказать. Также во время подготовки чемпион становится уязвим в командном сражении.
...
Фаза Q windup длится 0.63 секунды. За это время противнику легко уклониться от умения. Фаза Q recovery отменяется стандартными способами.
...
Фаза E recovery отменяется стандартными способами.

**Защитное комбо Caitlyn E-Q** решает проблему умения Q. Во время фазы Q windup чемпион перемещается. Так он разрывает дистанцию с противником и скрывает направление снаряда.
...
Вот примеры комбо, которые работают аналогично:
