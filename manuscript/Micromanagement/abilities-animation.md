...
Теперь поговорим о **статических умениях**. Это самый распространённый тип умений в League of Legends. Среди них есть атакующие, эффекты контроля, исцеление, усиление и щиты.

Большинство статических умений проходят по базовой схеме анимации. Её демонстрирует иллюстрация 3-7. Также среди статических умений встречается оба отклонения от базовой схемы: замена одной из фаз на channel и отсутствие фазы windup.
