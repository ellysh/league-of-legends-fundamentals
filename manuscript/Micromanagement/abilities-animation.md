...
Идея комбо заключается в том, чтобы фаза windup статического умения Q маскировала анимацию модификатора атаки W. Он имеет свойство uncancellable windup. Это позволяет запустить фазу W windup и сразу выполнить умение Q. Его анимация будет проигрываться поверх модификатора атаки W.
