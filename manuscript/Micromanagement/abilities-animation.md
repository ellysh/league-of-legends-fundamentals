...
Пусть умения с этими темя фазами будут нашим **базовым шаблоном**. Некоторые умения отличаются от этой схемы. Будем рассматривать их как отклонение от шаблона.

Начнём с простых умений, которые укладываются в базовый шаблон. Иллюстрация 3-7 демонстрирует временную диаграмму такого умения — Ashe W.
