...
**Динамических умений** в игре намного меньше чем статических. Среди них есть атакующие и защитные. Оба типа так или иначе перемещают чемпиона.
...
Рассмотрим пример комбо для каждой из этих целей.
