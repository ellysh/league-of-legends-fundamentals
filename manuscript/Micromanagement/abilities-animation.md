...
Мы рассмотрели типы умений и базовые приёмы для работы с их анимацией. Некоторые чемпионы имеют сложные комбо, которые состоят из четырёх и более действий. Исполнить их невозможно, если не знать базовые приёмы.

Рассмотрим пример сложного комбо — **Samira fastest S combo**. За одну секунду оно наносит шесть ударов по противнику: два АА и четыре умениями. Каждый удар отличается от предыдущего. Таким образом срабатывает пассивное умение Samira, которое позволяет применить умение R.

[Следующее видео](https://www.youtube.com/watch?v=S2Uxl5v_f6Q) демонстрирует fastest S combo. Профессиональный игрок Jackspektra объясняет его по шагам в [этом видео](https://www.youtube.com/shorts/Ksvye6VP7-M?app=desktop).

Запишем комбо, как последовательность команд:
{line-numbers: false, format: text}
```
AA-W-E-Q-AA-R
```
...
Просмотрите видео комбо в замедленном режиме. Вы заметите, что за каждым дефисом стоит один из приёмов работы с анимацией. В комбо этих приёмов пять:
