...
Иллюстрация 3-15 демонстрирует временную диаграмму умения R Jinx.
...
Иллюстрация 3-16 демонстрирует временную диаграмму умения E Jinx.
...
Иллюстрация 3-17 демонстрирует временную диаграмму комбинации E-R Jinx.
...
В точке B начинается фаза анимации recovery умения E. Чтобы качественно исполнить комбо, надо нажать кнопку R в течение фазы E firing или сразу после неё. Тогда в точке B начнётся маскированная анимация R windup, которая длится 0.6 секунды.
