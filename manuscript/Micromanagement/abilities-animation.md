...
2. В точке B сразу после начала анимации Q windup игрок нажимает flash. Так он может уклониться, например, от летящего снаряда.

3. В точке C чемпион заканчивает фазу Q windup. После этого он находится в состоянии Q charged и сохраняет заряд.

4. В точке D игрок нажимает кнопку Q. Чемпион выполняет фазу Q firing: рывок в указанном направлении.

5. В точке E чемпион начинает фазу Q recovery. Её можно отменить атакой, передвижением, заклинанием призывателя, активным эффектом предмета или другим умением чемпиона.

Защитные комбо с динамическим умением и flash решают следующие задачи:
