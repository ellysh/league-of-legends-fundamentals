...
1. В точке A игрок нажимает кнопку E и даёт команду на атаку цели. Чемпион начинает проигрывать фазу E windup.
...
При исполнении этого комбо возможна только одна ошибка. Игрок может начать его, когда цель находится вне дальности атаки чемпиона. Тогда можно нажать flash до начала анимации E windup.
