...
Первые две цели актуальны только для медленных статических умений с фазой windup. Быстрые статические умения её не имеют. Они начинаются сразу с фазы firing.
...
Третий пример смены позиции с flash — **защитное комбо Ezreal R-F**.

У умения Ezreal R есть две проблемы. **Во-первых**, долгая фаза windup в течение одной секунды. Пока она идёт, чемпион не может двигаться и становится лёгкой целью в сражении. **Во-вторых**, предсказуемая траектории снаряда. Анимация windup явно указывает, куда полетит снаряд.

Защитное комбо R-F решает обе проблемы. Его идея состоит в том, чтобы маскировать анимацию windup с помощью flash и одновременно разорвать дистанцию с противником. Так чемпион выигрывает время и скрывает от противника направление снаряда.
...
3. В точке C чемпион проигрывает фазу Q firing. Она длится примерно 0.02 секунды.

4. В точке D чемпион начинает фазу Q recovery. Она длится примерно 0.65 секунды. Её можно отменить атакой, передвижением, заклинанием призывателя, активным эффектом предмета или другим умением чемпиона.

При исполнении этого комбо важно нажать flash как можно раньше. В противном случае произойдёт маскировка анимации R windup. Одна её часть будет проигрываться в начальной позиции чемпиона, а другая в конечной. Это плохо, потому что противник увидит направление снаряда.
...
#### 3.2.4.4 Сокращение задержки перед фазой firing
...
Умение R заключается в том, что Kennen создаёт вокруг себя область шторма. В течение трёх секунд все противники в этой области получают урон. Временную диаграмму этого умения демонстрирует иллюстрация 3-15.
...
#### 3.2.4.5 Маскировка анимации в комбо Jinx
...
#### 3.2.4.6 Маскировка анимации в комбо Darius
