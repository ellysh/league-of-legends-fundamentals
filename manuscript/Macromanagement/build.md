...
2. **Grasp of the Undying** + **Second Wind** + **Revitalize** — связка против контрматчапа (например, melee vs range). Даёт хорошее лечение, которое позволяет оставаться на линии и получать фарм. Эти руны хорошо дополняет предмет Doran Shield.
...
2. **Guardian** + **Font of Life** + **Bone Plating** + **Deep Ward** — связка для чемпионов класса Disengage Tank на роли саппорт. Примеры: Braum, Taric. Руна Deep Ward позволяет намного лучше контролировать карту.
