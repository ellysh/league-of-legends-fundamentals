...
Драфт определяет билд. Эти два аспекта игры неразрывно связаны. Мы рассмотрим их в этом разделе. Также разберём типичные ошибки новичков при выборе чемпионов и билдов.
