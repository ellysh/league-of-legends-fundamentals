...
Создание угрозы противникам — это приём, который позволяет команде захватить контроль над картой.

Сначала определим, что означает термин **угроза** в League of Legends. Так называется действие игрока или команды, которое ставит противников перед выбором:

1. **Отреагировать** на него и потерять темп.
...
Любую угрозу следует выполнять одновременно с такими действиями:

1. **Push линии**. Если угроза создаётся на одной линии и при этом пушится другая, это называется сплит-пуш.
...
Чаще всего в League of Legends применяются следующие виды угроз:

1. **Push боковой линии** одним сильным чемпионом.

2. **Техника pin и fog**.

3. **Дайв противника** под его башней.

4. **Взятие эпического монстра** одним чемпионом.
...
Из-за удалённости боковых линий, игрокам сложнее реагировать на создаваемые там угрозы. Они должны прогнозировать перемещения вражеских чемпионов и фронта столкновения миньонов. Только так они смогут распознать угрозу и вовремя на неё отреагировать. Без планирования наперёд, у игроков не будет такой возможности. Они будут вынуждены игнорировать угрозу. Это даст противнику дополнительные ресурсы за разрушение очередной башни.
