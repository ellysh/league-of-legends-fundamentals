...
Взятие объектов — это одна из двух основных задач, которую команды решают в мидгейме и лейтгейме. Часто результат контеста эпического монстра определяет исход партии. Рассмотрим, как можно повысить шансы на победу в нём.

#### 4.3.4.1 Подготовка к объекту

>>>R2

Подготовка к контесту эпического монстра начинается с правильных таймингов для recall. Возвращаться на базу следует за 30-60 секунд до возрождения монстра. Конкретный тайминг зависит от чемпиона игрока.
...
Если чемпион действует по плану front-to-back, он может прийти на объект немного позже. Его тайминг для recall — это 30-40 секунд до возрождения монстра. Главное для него — успеть сгруппироваться с командой до подхода противников.
...
Push линий сдвигает фронт столкновения миньонов на сторону карты противника. Таким образом миньоны дают обзор на перемещения противников. Для подготовки к взятию дракона надо отпушить среднюю и нижнюю линии. Для контеста герольда или барона пушится верхняя и средняя линии.
...
2. Ганг противника, который пушит ближайшую боковую линию.

3. Атаковать противника, который смещается к объекту и отстал от команды.

Обзор вокруг объекта важен как на высоком, так и на низком уровне Эло. Он даёт информацию, когда противники начали забирать монстра. Если они делают это без темпа, их можно легко наказать. Для этого надо зайти на объект вторым номером и атаковать противников, а не монстра.
