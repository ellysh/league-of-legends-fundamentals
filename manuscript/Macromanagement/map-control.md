...
На стадии лейнинга для команды самые приоритетные задачи следующие:

1. Максимально эффективно собирать все доступные ресурсы на карте.
2. Мешать противникам собирать ресурсы.

Первая роль в таблице 4-9 — **мидлейнер**. С самых ранних версий игры на эту роль выбирают чемпионов класса AP Carry. У них низкая мобильность, что делает их уязвимыми для гангов. Такие чемпионы полагаются на урон от умений. Поэтому они лучше скейлятся от уровня, чем от предметов.

Против класса AP Carry очень хорошо работает класс Assassin. Поэтому таких чемпионов часто берут на роль мидлейнера как контрпик. Их основной урон тоже идёт от умений. Поэтому ассасины также хорошо скейлятся от уровня, как AP Carry.
...
Средняя линия подходит для типичных AP Carry чемпионов лучше всего. **Во-первых**, на ней расстояние между Т1 башнями самое короткое. Поэтому игроку легче отступить под свою башню, если его атакует вражеский лесник. **Во-вторых**, чемпион может безопасно стоять на этой линии один без поддержки. Тогда он быстрее получит нужный уровень и достигнет своего power spike.
...
Третья роль в таблице 4-9 — **ADC**. Классические чемпионы для этой роли имеют низкую мобильность, как и AP Carry. Это делает их уязвимыми для гангов. Такие чемпионы полагаются на урон от автоатак, а не умений. Поэтому они лучше скейлятся от предметов, а не от уровня.

Проблема роли ADC с уязвимостью для гангов решается двумя путями. **Во-первых**, они идут на вторую по длине линию после средней. Расстояния между Т1 башнями там всё-таки меньше, чем на верхней линии. **Во-вторых**, на линии вместе с ADC стоит саппорт. Он защищает союзника в случае ганга и позволяет ему выйти из под удара.

Следующая роль — **саппорт**. В начале партии он помогает своему ADC на линии. В противном случае союзника будут часто убивать и от него не будет пользы в мидгейме. После первого recall саппорт может присоединиться к леснику, чтобы усилить очередной ганг или инвейд. Опытные саппорты часто выполняют ротации по карте на стадии лейнинга. Так они мешают противникам получать ресурсы.

На высоком уровне Эло популярен приём **смены линий** (lane swap) на стадии лейнинга. Его идея заключается в том, что игроки меняются линиями с первой минуты матча или после первого recall. Наиболее частая форма lane swap — когда ADC и саппорт идут на верхнюю линию. Там они стоят против вражеского топлейнера. Таким образом игроки навязывают оппонентам координационную игру: противникам выгодно повторить lane swap. Если они этого не делают, выполнившая приём команда получает следующие преимущества:
...
I> Профессиональный игрок [Jake Sharwood](https://lol.fandom.com/wiki/Rogue_(Jake_Sharwood)) (известный как Rogue) подробнее объясняет распределение чемпионов по линиям [следующем видео](https://www.youtube.com/watch?v=J-ORki8NPfM).
...
На стадии мидгейма для команды на первом месте стоят следующие задачи:

1. Контроль карты
2. Взятие объектов.

Центр карты имеет ключевое значение для решения этих задач. Иллюстрация 4-11 показывает зону радиусом 5600 (это 1/4 диагонали карты). Её центр совпадает с серединой средней линии.
...
Это означает, что чемпион на средней линии сможет активно участвовать во всех важных событиях на карте. При этом средняя линия остаётся самым безопасным местом для фарма, потому что она короткая.

В мидгейме ADC и саппорт часто переходят с нижней линии на среднюю. На это есть несколько причин. **Во-первых**, чем больше игроков находятся на средней линии, тем лучше команда контролирует карту. Это связано с тем, что все они могут быстро сместиться на любой объект. Также со средней линии можно легко перенести давление на одну из боковых. Мы приём рассмотрим переноса давления далее.

**Во-вторых**, после выхода в мидгейм ADC очень уязвим на боковой линии. Как правило он отстаёт на 2 уровня от вражеского топлейнера, мидлейнера и лесника. Причина в том, что всю стадию лейнинга ADC делил опыт со своим саппортом. Поэтому команде выгодно разместить своего ADC на средней линии, где можно безопасно фармить.

**В-третьих**, команде выгодно, чтобы в мидгейме её ADC участвовал во всех командных действиях. Причина в том, что к этому времени он собирает второй предмет и достигает своего power spike. Это позволяет ADC наносить значительный урон в сражениях. Чтобы ADC был доступен для всех командных действий, он должен находиться в центре карты (см. иллюстрацию 4-11). Других способов достичь этой цели нет. Обычно у ADC нет заклинания телепорт или другого инструмента на мобильность. Вместо телепорта ADC берёт одно из заклинаний на выживаемость.
...
На профессиональном уровне смена линий может работать иначе. Обычно команда берёт мобильного чемпиона на роль мидлейнера или ADC. Тогда этот чемпион сможет стоять на боковой линии в мидгейме. Примеры ADC с мобильностью: Kai'Sa и Lucain. Они могут уходить от гангов и догонять противников на длинных линиях. Примеры мидлейнеров с мобильностью: Ahri и Akali. Они тоже хорошо стоят на боковой линии. Обратите внимание, что профессионалы никогда не берут немобильного мидлейнера и ADC.
...
I> Jake Sharwood объясняет концепцию tempo lines в [следующем видео](https://www.youtube.com/watch?v=dKTZbylOF8A).
