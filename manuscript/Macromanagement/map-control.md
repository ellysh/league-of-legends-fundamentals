...
Создание угрозы противникам — это один из эффективных приёмов, который позволяет команде захватить контроль над картой.

Сначала определим, что означает термин **угроза** в League of Legends. Так называется действие игрока или команды, которое ставит противников перед выбором: отреагировать на него или проигнорировать, но за это потерять что-то.
...
1. **Отреагировать** на угрозу и находиться под своей башней. Тогда противник сможет фармить миньонов и получит за них ресурсы.

2. **Проигнорировать** и покинуть свою линию. Тогда противник потеряет ресурсы за миньонов, а его башня получит урон.

Если в момент создания угрозы на карте больше ничего не происходит, то выбор противника очевиден — отреагировать. Поступив так, он не даст игроку и его команде никакого преимущества 

Теперь допустим, что в момент создания угрозы команда игрока контестит ближайшего эпического монстра. В этом случае противнику намного сложнее сделать выбор. Если он отреагирует на угрозу, то не сможет присоединиться к своей команде и она будет сражаться в меньшинстве. Если он проигнорирует угрозу, то даст игроку преимущество на линии. Это сделает его стадию лейнинга сложнее.

Из нашего примера можно сделать несколько выводов. Во-первых, угрозы создаются не просто так, а с какой-то конкретной целью. Если в момент создания угрозы нет никакого командного действия, противник просто отреагирует на неё. Тогда игрок впустую потратит свою возможность для создания угрозы и не извлечёт из неё выгоды.

Во-вторых, реакция противников на угрозы зависит от множества факторов. Если оппонент имеет низкий ранг, он может просто не понять смысл угрозы и своих вариантов для выбора. В этом случае у игрока появляется шанс извлечь максимальную выгоду. Ему стоит создавать угрозу снова и снова, провоцируя противника на неправильный ответ.

Реакция противников на угрозы будет разной в ранговых и соревновательных партиях. В ранговых играх участников больше заботит собственная выгода. Если игнорирование угрозы создаст игроку серьёзные проблемы на линии, скорее всего он отреагирует на неё. В соревновательных партиях координация в команде лучше. Игроков больше заботит общий ход партии, чем личная выгода. Поэтому они могут игнорировать угрозы ради выгодных командных действий. Также профессиональные игроки умеют заранее предотвращать саму возможность создать им угрозу.

Если угроза будет эффективной, тот кто её создал сможет извлечь выгоду. Для этого есть два условия:

1. Угроза должна ставить противника перед сложным выбором. Оба варианта ответа (отреагировать или игнорировать) должны давать команде игрока преимущество либо в виде ресурсов, либо в виде темпа и контроля карты.
...
#### 4.2.2.1 Угрозы на боковой линии

В мидгейме важную роль играет то, что происходит на боковых линиях. Их состояние определяет многие решения команды.

Состояние линии определяют следующие факторы:
...
Почему боковые линии оказываются важнее, чем средняя? Потому что на них легче создавать эффективные угрозы для вражеской команды.

Средняя линия легко доступна из других областей карты. Это означает, что если одна команда выполнит push на средней линии, противники отреагируют на него с минимальными усилиями. Им понадобиться немного времени, чтобы дойти до своей башни и защитить её.

Боковые линии удалены от центра карты. Если противники находятся далеко, они не успеют вовремя остановить push игрока. Поэтому угроза игрока разрушить очередную башню на этой линии будет эффективна. Противникам понадобятся значительные усилия и ресурсы, чтобы отреагировать на неё. В случае ошибки позиционирования они заплатят использованием заклинания телепорт.

Игнорирование угрозы на боковой линии обходится дороже, чем на средней. Награда локальным золотом за разрушение Т2 башни на боковой линии составляет 675. Награда локальным золотом за Т2 башню на средней линии равна 425. Разница в 250 золота — это почти доход чемпиона на линии в течении 1 минуты за фарм двух волн миньонов.

Из-за удалённости боковых линий, игрокам сложнее реагировать на создаваемые там угрозы. Они должны прогнозировать перемещения вражеских чемпионов и фронта столкновения миньонов. Только так они смогут узнать о создаваемой угрозе и вовремя отреагировать. Без планирования наперёд, у игроков не будет такой возможности. Они будут вынуждены проигнорировать угрозу и таким образом дать противнику дополнительные ресурсы за разрушение очередной башни.


Только так они смогут предугадать угрозу на боковой линии и вовремя отреагировать на неё. Другими словами, игроки должны планировать свои действия на боковых линиях. Это открывает пространство для координационных игр.
...
Иллюстрация 4-13 демонстрирует эти действия на карте Summoner's Rift.

{caption: "Иллюстрация 4-13. Шаги для исполнения техники pin и fog", width: "100%"}
![Шаги pin и fog](images/Macromanagement/pin-and-fog-steps.png)
...
Зелёная точка с номером 1 означает пуш и креш синих миньонов под Т2 башню красной команды. Эта волна миньонов отмечена зелёной стрелкой.

После пуша игрок заходит во вражеский лес. Там он расставляет варды в двух точках, которые отмечены номером 2. В нижней точке ближе к средней линии нужно поставить жёлтый вард. В верхней точке ближе к верхней линии можно поставить жёлтый или красный вард. В этой позиции игроку будет проще защищать красный вард. В то же время он помешает противникам получить обзор в этой области.

Последнее действие игрока — перехватить следующую волну красных миньонов как можно как можно ближе к Т2 башне красный команды. Точка перехвата отмечена на иллюстрации цифрой 3. Волна миньонов отмечена красной стрелкой.

Техника pin и fog открывает перед игроком следующие возможности:
...
5. Устроить засаду во вражеском лесу.
