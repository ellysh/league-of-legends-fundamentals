...
Создание угрозы противнику — это сильный приём микроменеджмента. С его помощью команда может выиграть темп. Преимущество по тему даёт возможность получить контроль над картой. Он позволяет захватывать объекты на карте. Именно вокруг этих целей строится игра в мидгейме и лейтгейме.
