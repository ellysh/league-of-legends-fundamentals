...
Правильные ротации дают команде преимущество и контроль над картой. Теперь допустим, что команда получила решающее преимущество. Например, забрала барона или вышла в значительный плюс по золоту. Рассмотрим, как реализовать его максимально эффективно и довести до победы.

Когда команда получает решающее преимущество, она должна закончить игру как можно быстрее. Это не даст противникам возможности отыграться. Поэтому первостепенной задачей становится штурм вражеской базы.

Самое сильное давление на базу противника создаёт одновременный push по двум линиям: средней и одной из боковых. Это наиболее эффективная стратегия после взятия барона.
...
![Давление по двум линиям](images/Macromanagement/blue-jungle-wards.png)
...
Для выполнения push по двум линиям игроки синей команды делятся на три группы:
...
Позиция групп на карте отмечена точкой с соответствующим номером. Рассмотрим задачи каждой из них.
...
**Группа 2** лесник + саппорт. Контролируют вражеский лес между линиями, на которых выполняет push. Они находятся в в зоне доступности для групп 1 и 3. Основная задача лесника и саппорта — прийти на помощь союзникам на линии, если их атакуют противники

**Группа 3** мидлейнер или топлейнер. Игрок выполняет fast push на боковой линии. Его задача — штурм вражеской Т2 башни. Таким образом игрок создаёт дополнительную угрозу и вынуждает противников разделиться.

Обратите внимание на диагонали темпа на иллюстрации 4-21. Группы 1 и 2 находятся на back tempo, а группа 3 — на front tempo. Несмотря на это, все группы действуют согласованно и выполняют один плей. Это происходит благодаря группе 3, которая поддерживает давление на обе линии.

Давление по двум линиям имеет следующие преимущества:

1. ADC команды хорошо защищён союзниками.

2. Противники вынуждены разделяться, что может привести к плохой координации и ошибкам.
...
Push по трём линиям намного слабее, чем по двум. В этом сценарии у противников больше пространства для действия. Они могут контратаковать на верхней или нижней линии. С другой стороны, у союзников появляется больше возможностей допустить ошибку. Например, оказаться на back tempo диагонали вне зоны доступности своей команды.
