...
Ротация треугольник имеет несколько вариантов исполнения. Один из них называется приём **pin and fog**. Дословно это переводится как "прикрепить и затуманить".

Идея приёма состоит в том, чтобы создать сразу две угрозы: на боковой линии и во вражеском лесу. Если противники на них не реагируют, то теряют значительные ресурсы.
...
Приём выполняется, когда разрушена вражеская Т1 башня на боковой линии. Это открывает игроку доступ во вражеский лес. Приём состоит из двух основных шагов:

* **Первый шаг** называется pin (прикрепить). Игрок выполняет push и крешит свою волну во вражескую Т2 башню. Это первая угроза. Если оппонент её игнорирует, то теряет фарм. Если он реагирует, то оказывается привязан к своей башне на какое-то время.

* **Второй шаг** называется **fog** (затуманить). Игрок берёт под контроль вражеский лес. Для этого он расставляет варды в ключевых точках. Они дают игроку возможность безопасно фармить лесные лагеря противника. Это вторая угроза. Если вражеский лесник её игнорирует, то лишается фарма. Если он реагирует, то выпадает из командного действия.

Иллюстрация 4-16 демонстрирует действия игрока при исполнении приёма pin and fog.
...
**Второе действие** — игрок расставляет варды во вражеском лесу. Это две точки отмеченные номером 2. В нижних кустах ближе к средней линии ставится жёлтый вард. В верхних кустах — жёлтый или красный вард. Здесь игроку будет проще защитить красный вард, чем в нижних кустах.

**Третье действие** — игрок перехватывает и фармит очередную волну красных миньонов. Это нужно сделать как можно ближе к Т2 башне. Точка перехвата отмечена на иллюстрации номером 3. Красная стрелка отмечает волну вражеских миньонов.

**Четвёртое действие** — игрок фармит лагеря монстров, которые уже возродились. Они отмечены на иллюстрации точками с номером 4.

Если противники реагируют на приём pin and fog, игрок и его команда получают темп. Игрок может реализовать его следующими способами:
...
При исполнении приёма pin and fog разведка имеет ключевое значение. Вернёмся к иллюстрации 4-16. Обратите внимание, что оба варда стоят между базой противника и лагерями лесных монстров в верхнем лесу. Какой бы лагерь не фармил игрок, он заранее узнает о приближении противников.

Можно сформулировать следующее правило установки вардов:
...
Варды надо устанавливать максимально быстро. Самый оптимальный способ это сделать — пройти с нижней линии до точки под номером 1. После этого установить варды через стенки влево (точка с номером 2) и вправо (точка с номером 3). Они перекроют подходы в лес с вражеской базы.

Когда игрок красной команды исполняет приём pin and fog, варды устанавливаются аналогично в лесу синей команды. Точки для их установки симметричны относительно центра карты точкам на иллюстрациях 4-16 и 4-17.
