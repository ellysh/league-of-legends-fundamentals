...
Когда игрок постоянно выполняет fast push и остаётся на боковой линии, он нарушает обе концепции. В результате он не может присоединиться к командным действиям и становится уязвим для гангов. Ротации решают эти проблемы. Это может быть перенос давления на другую линию. Но чаще применяют **ротацию треугольник**.

Ротация треугольник применяется, когда разрушена вражеская Т1 башня. Алгоритм её исполнения выглядит так:
...
Ротацию выполняет синий топлейнер. Он разрушил Т1 башню противника на верхней линии. Она отмечена красным крестом. При этом его Т1 башня ещё стоит. Все остальные синие чемпионы находятся на средней лини в точке с номером 2. Они осаждают красную Т1.
...
Правильная реакция на ротацию треугольник — это такая же ротация треугольник. Рассмотрим иллюстрацию 4-17 с точки зрения красного топлейнера. Изначально он находится в точке 2 на средней линии с командой. Ему надо сместиться к своей Т2 башне на верхней линии. Там игрок забирает волну и толкает фронт столкновения миньонов на диагональ front tempo к точке с номером 3. После этого он возвращается на среднюю линию к команде.

Обычно опытные игроки выполняют ротацию треугольник по очереди: сначала пушит и смещается один, потом другой.
