...
I> Подробнее про сражение на объекте рассказывает Jake Sharwood в [следующем видео](https://www.youtube.com/watch?v=uxfxmBp1688).
...
Мы рассмотрели ряд важных концепций для игры в мидгейме и лейтгейме. Они объясняют, как правильно позиционироваться на карте, создавать давление на противников и получать преимущество в сражении на объекте. Рассмотрим, как научиться использовать эти концепции на практике.

### 4.3.5.1 Визуальные шаблоны для позиционирования

>>>R2

Концепции позиционирования на карте строятся вокруг визуальных шаблонов. Начнём с концепции зоны доступности. Чтобы эффективно её пользовать, вам нужно запомнить, как выглядят две типичные зоны на миникарте.
...
Если вы собираетесь контестить объект, вы должны находиться в его зоне доступности с радиусом 5600. Тогда если вражеская команда начнёт его забирать, вы успеете сместиться и принять участие в сражении.

**Вторую типичную зону доступности** приводит иллюстрация иллюстрация 4-21. Она имеет диаметр 7500 (радиус 3700). Этот диаметр равен 1/3 диагонали карты. Чемпион проходит от центра такой зоны до края примерно за 9 секунд.

Если вы собираетесь принять участие в командном сражении, вы должны находиться на расстоянии не более 3600 от своей команды. Тогда после engage одной из сторон вы вероятно успеете прийти на помощь союзникам.
