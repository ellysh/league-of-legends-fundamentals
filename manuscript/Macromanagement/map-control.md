...
Это плохой план и он часто заканчивается неудачно по нескольким причинам. Есть два типичных сценария, по которым это происходит.
...
Эти сценарии можно избежать, если выполнять сплит-пуш правильно и выполнять ротации. Они усилят давление на противников, позволят присоединиться к командным действиям, получить больше ресурсов и избежать гангов.
...
Перенос давления на другую линию решает сразу несколько задач. Поэтому его часто применяют во время сплит-пуша на боковой линии. Он особенно эффективен, когда вражеских чемпионов не видно на карте и есть опасность ганга.
...
Когда игрок постоянно выполняет fast push и остаётся на боковой линии, он нарушает обе концепции. Это не позволяет ему присоединяться к командным действиям и делает его уязвимым для гангов. Чтобы избежать этих проблем, игрок должен выполнять ротации. Стандартная называется **ротация треугольник**.
...
2. Сместить к союзникам на той же диагонали темпа, чтобы оказаться в зоне их доступности.
...
Ротация треугольник обычно начинается с fast push на боковой линии, но её так же можно начинать и на средней линии. Тогда после командного действия игрок возвращается на неё же.
...
Ротацию выполняет синий топлейнер. Он разрушил Т1 башню противника на верхней линии. При этом его Т1 башня ещё стоит. Все остальные синие чемпионы находятся на средней лини в точке с номером 2. Они осаждают красную Т1.

**Первое действие** игрока отмечено синей точкой с номером 1. Это пуш союзных миньонов на сторону карты противника. Если противника нет на линии, можно сделать креш во вражескую Т2 башню. Синяя стрелка обозначает движение игрока и его волны. В результате игрок может оказаться на front tempo один. Это опасно, поэтому задерживаться в этой позиции нельзя.

**Второе действие** — ротация в сторону союзников. Игрок должен оказаться с ними на одной диагонали темпа. При этом он должен попасть в зону доступности очередного объекта. На иллюстрации 4-17 союзники атакуют красную Т1 башню на средней линии. Поэтому задача игрока — оказаться в её зоне доступности. Она отмечена жёлтым кругом.

**Третье действие** — вернуться к Т1 башне на верхней линии. Эта позиция отмечена точкой с номером 3. Пока игрока не было на линии, фронт столкновения миньонов отпушился на back tempo под Т1 башню. Задача игрока — вернуть фронт столкновения на диагональ front tempo в точке 1 или сделать креш в Т2 башню противника.
...
Правильная реакция на ротацию треугольник — это такая же ротация треугольник. Противник смещается к своей Т2 башне на верхней линии. Он забирает волну и толкает фронт столкновения миньонов на диагональ front tempo. После этого противник возвращается к своей команде. Обычно опытные игроки выполняют ротацию треугольник по очереди: сначала пушит и смещается один, потом другой.
