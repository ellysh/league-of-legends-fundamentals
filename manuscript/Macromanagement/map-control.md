...
Угрозы можно комбинировать. Если команда уже имеет темп, она может создать несколько угроз в разных областях карты. Такая комбинация может запутать противников: им надо подсчитать потери от игнорирования каждой угрозы. Правильная реакция в таком случае — отреагировать на угрозу, которая потенциально ведёт к самым большим потерям. Начинающие игроки часто не могут правильно оценить эти потери и ошибаются в своём выборе.
