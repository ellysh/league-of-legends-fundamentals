...
Сплит-пуш — это самый распространённый приём, который игроки исполняют на боковой линии. Он кажется простым, но на практике его редко выполняют правильно.

I> Профессиональный игрок Jake Sharwood объясняет, как правильно выполнять сплит-пуш в [следующем видео](https://www.youtube.com/watch?v=TiCeoxQYCuk).

Сплит-пуш может закончиться неудачно по нескольким причинам. Есть два типичных сценария, по которым это происходит.
...
**Второй сценарий** — игрок выполняет push на боковой линии. Противники реагируют на угрозу и атакуют игрока вдвоём или втроём. В это время союзники получают темп на каком-то объекте, но не реализуют его.
...
Если игрок выполняет сплит-пуш правильно, он сможет избежать эти сценарии. Рассмотрим, как это сделать.

#### 4.3.3.2 Перенос давления на другую линию

>>>R1

При выполнении сплит-пуш очень важны тайминги движения волн. В разделе "4.1.3.1 Исполнение fast push" мы рассмотрели, как изменяется скорость волн на протяжении партии. Вот основные правила:
...
2. **Вторая и последующие волны** — миньоны на боковых линиях получают ускорение. Поэтому на всех линиях они встречаются одновременно. Ускорение постепенно уменьшается в зависимости от минут игры.

3. **14 минута игры** — ускорение миньонов заканчивается. Поэтому на средней линии они встречаются раньше, чем на боковых. Это продолжается до конца игры.

Когда волны на средней и боковых линиях встречаются не одновременно, у игрока появляются возможности для сильных ротаций. Рассмотрим пример.

Иллюстрация 4-15 демонстрирует игровую ситуацию в мидгейме.
...
Допустим, что идёт 15 минута партии. Это означает, что ускорение миньонов на боковых линиях закончилось. Прямоугольники означают волны миньонов. Синие — синей команды, а красные — красной.

Топлейнер синей команды находится в точке с номером 1. Он выполнил fast push и чистый креш в Т1 башню на своей линии. Теперь у него есть два варианта:

1. Атаковать Т1 башню.
2. Выполнить ротацию на среднюю линию.

Если у Т1 башни высокий уровень здоровья и игрок не успеет её забрать с имеющейся волной, ему нет смысла оставаться на верхней линии. Он просто теряет время. Вместо этого игроку выгоднее сместиться на среднюю линию в точку с номером 2. Так он перенесет своё давление с верхней линии на среднюю. Этот приём называется **перенос давления на другую линию** (transfer push to another lane).

Выполняя перенос давления, игрок должен следить за движением своих волн миньонов. Ещё раз обратимся к иллюстрации 4-15. Если игрок начнёт двигаться прямо сейчас, он успеет прийти на среднюю линию одновременно со следующей союзной волной. Правильный тайминг важен. Он позволяет выполнить push и чистый креш в Т1 башню на средней линии.
...
На иллюстрации 4-15 игрок переносит давление на другую линию для атаки двух Т1 башен противника. Тот же приём можно использовать и для защиты от сплит-пуш. Иллюстрация 4-16 демонстрирует, как это сделать.

{caption: "Иллюстрация 4-16. Перенос давления для защиты", width: "100%"}
![Перенос давления pfobnf](images/Macromanagement/transfer-push.png)

Снова идёт 15 минута партии. Прямоугольники означают волны миньонов команд.

Красный топлейнер разрушил синюю Т1 башню на своей линии. Он продолжил сплит-пуш и теперь атакует Т2 башню со своей волной в точке с номером 1.

Синий мидлейнер выполняет fast push и чистый креш на своей линии в точке 2. Дальше он выполняет перенос давления на верхнюю линию. Для этого игрок смещается в точку 1. При правильном тайминге он достигает её одновременно с союзной волной миньонов. После этого игрок атакует вражеского топлейнера вместе с союзниками. Это действие приводит к следующим результатам:
...
Перенос давления на другую линию решает сразу несколько задач. Поэтому его часто применяют во время сплит-пуша на боковой линии. Он особенно эффективен, когда вражеских чемпионов не видно на карте.
