...
Push боковой линии — самая распространённая угроза, которую создают игроки в League of Legends. Её достаточно просто реализовать. С другой стороны, ответить на эту угрозу может быть сложно из-за ошибок позиционирования на карте. Разберёмся, как правильно её создавать.

На ход партии в мидгейме больше влияет состояние боковых линий, а не средней. Причина этого в том, что средняя линия легко доступна из любой области карты. Если игрок выполнит push средней линии, противники быстро на это отреагируют, независимо от их местоположения на карте.

Боковые линии удалены от центра карты и поэтому труднодоступны. Для примера предположим, что игрок выполняет push верхней линии, а противники в это время забирают дракона в нижней части карты. Если у них нет инструментов на мобильность, они не успеют остановить push вовремя. Игрок может забрать одну внешнюю башню и выполнить креш волны в следующую. Если игроку удастся разрушить ингибитор, это создаст огромное давление на вражескую команду.
...
Представим **первую ситуацию** — на средней линии произошло командное сражение, в котором победила красная команда. Её игроки сразу же разрушили синюю Т1 башню. Топлейнер красной команды остаётся на средней линии и выполняет push. Так он пытается создать угрозу и выиграть время, чтобы его союзники смогли забрать барона.
...
Действия синей команды отмечены синем цветом. Её чемпионы возродились на фонтане и находятся на своей базе в точке 3. Их цель — помешать красной команде забрать барона в точке 2. Для этого игроки выберут кратчайший путь к логову монстра, который отмечен стрелкой. Следуя по этому маршруту, они остановят push на средней линии и тем самым устранят угрозу. При этом игроки могут дойти до логова барона вовремя, чтобы навязать там сражение.

Пример показывает, что push средней линии редко создаёт эффективную угрозу. Через эту линию идут маршруты к самым важным областям карты. Поэтому противники остановят такой push с минимальными затратами времени и ресурсов.

Теперь рассмотрим **вторую ситуацию**. В ней произошли те же события, что в первой — красная команда выиграла сражение на средней линии и решает забрать барона. Но теперь её топлейнер смещается на нижнюю линию и выполняет push там.
...
Действия красной команды отмечены красным цветом. Прежде всего топлейнер разрушает синюю Т1 башню с низким уровнем здоровья — она отмечена красным крестом. Далее игрок выполняет push и креш миньонов в синюю Т2 башню в точке 1. Точка с номером 2 означает, что команда в это время начинает забирать барона.

Чемпионы синей команды возродилась на фонтане и выходят с базы в точке 3. Теперь игроки оказалась перед сложным выбором:

1. Игнорировать угрозу и двигаться на барона по кратчайшему пути.

2. Отреагировать на угрозу на нижней линии и защитить Т2 башню.

Первый вариант приведёт к тому, что красный топлейнер разрушит Т2 башню, а возможно и Т3. Второй вариант вынуждает игроков разделиться. Поэтому в сражении на бароне красная команда будет слабее и может снова проиграть. Оба варианта дают синей команде преимущество. Это признак эффективной угрозы.

Можно вывести следующее правило для создания эффективной угрозы:
...
Применим это правило к ситуации на иллюстрации 4-14. Игрок может создать угрозу только на нижней линии. Потому что Т2 башни на верхней и средней линиях находятся в зоне доступности от логова барона.

Кроме геометрии карты есть ещё одна причина, по которой угроза на боковых линиях эффективнее, чем на средней. Награда за разрушение Т2 башен там больше. Она составляет 675 локального золота, а на средней — всего 425. Поэтому если команда игнорирует угрозу на боковой линии, противник получит значительные ресурсы.

#### 4.3.2.3 Ротация "треугольник"
