...
Состояние боковых линий во многом определяет ход партии в мидгейме. Некоторые коучи даже выделяют отдельную тему под названием "макро на боковой линии" (side lane macro). Она считается одной из самых сложных в League of Legends. Разберёмся, почему боковые лини так важны.

**Первая причина** — это геометрия карты. Средняя линия легкодоступна из любой области карты. Если на ней происходит какое-то командное действие, игроки могут быстро к нему присоединиться. Например, синяя команда может собраться и начать push линии. Тогда красная команда тоже успеет собраться и остановить это давление.

С другой стороны, боковые линии удалены от центра карты и поэтому труднодоступны. Если командное действие происходит на боковой линии, присоединиться к нему смогут только чемпионы, находящиеся в зоне доступности с радиусом около 6000. По этой причине остановить push там сложнее.

**Вторая причина** — угрозы на боковых линиях намного эффективнее, чем на средней. Это следствие из геометрии карты.

I> **Угроза** — это действие игрока или команды, которое позволяет получить какое-то преимущество.

Создание угрозы — это сильный приём на уровне макро. Он даёт команде темп на каком-то объекте. Темп же помогает достичь основных целей мидгейма: контролировать карту и забирать объекты.

Если команда создала эффективную угрозу, противники вынуждены выбирать: реагировать на неё или игнорировать. В первом случае они потеряют темп на объекте, во втором — отстанут по ресурсам.
...
**Четвертая причина** важности боковых линий — на них можно получить больше ресурсов, чем на средней. Награда за разрушение боковой Т2 башни составляет 675 локального золота. Награда за Т2 башню на средней линии — всего 425 локального золота. Поэтому если команда игнорирует push на боковой линии, противник получит большое преимущество.

Рассмотрим типичные приёмы, которые можно исполнить на боковой линии.
