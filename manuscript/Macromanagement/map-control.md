...
Взятие эпического монстра — это опасное действие для обеих команд. Обычно объект пытается забрать сторона, которая в данный момент имеет преимущество. Но она может его потерять вместе с объектом, если события будут развиваться неудачно. С другой стороны, если отстающая команда проиграет сражение на бароне или старшем драконе, она проиграет игру.
...
Синяя команда выбирает между следующими действиями: пытаться забрать барона как можно быстрее, либо устроить засаду во вражеском лесу. Первый вариант опасен тем, что у красной команды может быть обзор на бароне. Тогда они узнают о действиях синей команды, подойдут на объект и нападут с тыла. Второй вариант в худшем случае приведёт к тому, что синяя команда потеряет время, пока противники пушат линии. Тогда они получат фарм и могут разрушить одну-две синие башни.
...
Ставки в этой координационной игре очень высоки. Забравшая барона команда сможет закончить игру или получить решающее преимущество. Поэтому лучшим решением для обеих команд будет не рисковать и отказаться от координационной игры. Это можно сделать с помощью разведки.

Начнём с вариантов для красной команды. **Во-первых**, голубой вард в логово барона покажет — начала ли синяя команда забирать объект. Если её нет в логове и на линиях, значит она устроила засаду. В этом случае будет выгоднее отпушить линии. После этого можно снова проверить логово барона.

**Во-вторых**, дальнобойные умения чемпионов позволяют проверить, есть ли противники в кустах. Такие умения могут прокнуть руну, эффект предмета или пассивное умение чемпиона. Это укажет на попадание по цели. Некоторые умения дают обзор.
...
Разведка срабатывает не в каждой координационной игре. Если это произошло, лучше следовать совету опытных игроков:
