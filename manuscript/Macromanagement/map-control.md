...
Есть концепция, которая объясняет правила позиционирования всей команды в мидгейме. Она называется **tempo lines** и дословно переводится, как "линии темпа". Чтобы не путать эти линии с линиями, по которым движутся волны миньонов, назовём эту концепцию "диагонали темпа".

I> Профессиональный игрок [Jake Sharwood](https://lol.fandom.com/wiki/Rogue_(Jake_Sharwood)) (известный как Chippys) концепцию tempo lines в [следующем видео](https://www.youtube.com/watch?v=dKTZbylOF8A).
...
![Зона доступности топлейнера](images/Macromanagement/three-tempo-lines.png)
...
Чем больше союзников находится на одной диагонали темпа, тем сильнее будет их плей. В идеале вся команда должна находиться на одной диагонали большую часть времени. Потому что совместные действия только двух или трёх чемпионов часто заканчиваются их убийством без какого-либо результата.
...
Игрок на front tempo ни в коем случае не должен устраивать какой-то плей самостоятельно.
...
После смерти и возрождения на фонтане игрок всегда оказывается на back tempo. Это очень плохая позиция с точки зрения команды. Он должен сразу двигаться к диагонали союзников, чтобы принять участие в очередном плее.

Инструменты чемпионов на мобильность позволяют им нарушать концепцию диагоналей темпа. Например, применив заклинание телепорт, игрок может быстро достигнуть front tempo из back tempo. Поэтому его позиция в back tempo не будет ошибкой.

Опытные игроки дают следующие советы по использованию концепции диагоналей темпа:

1. После recall или возрождения на фонтане не тратить время на фарм лесных монстров. Вместо этого игрок должен сразу двигаться к союзникам, чтобы достичь их диагональ темпа.

2. Делать recall после сражения или командного действия как можно раньше. Тогда игрок быстрее вернётся на front tempo со своей командной.

3. Не делать recall, когда у чемпиона остались ресурсы (здоровье и мана), мало пассивного золота и союзники остаются на карте.

4. Как можно больше времени находиться на front tempo вместе со своими союзниками, но не в самостоятельно.
...
Иллюстрация 4-13 демонстрирует угрозу через push средней линии.

{caption: "Иллюстрация 4-13. Угроза через push средней линии", width: "100%"}
...
Иллюстрация 4-14 демонстрирует угрозу, которую создаёт push нижней линии.

{caption: "Иллюстрация 4-14. Угроза через push нижней линии", width: "100%"}
...
Применим это правило к иллюстрации 4-14. Когда красная команда забирает барона, её топлейнер может создать угрозу только на нижней линии. Потому что Т2 башни на верхней и средней линиях находятся в зоне доступности от логова барона.
...
Иллюстрация 4-15 демонстрирует действия игрока для исполнении ротации треугольник.

{caption: "Иллюстрация 4-15. Действия для исполнении ротации треугольник", width: "100%"}
...
Рассмотрим действия игрока для исполнения приёма pin and fog. Их демонстрирует иллюстрация 4-16.

{caption: "Иллюстрация 4-16. Действия для исполнения приёма pin and fog", width: "100%"}
...
Разведка имеет ключевое значение для приёма pin and fog. Вернёмся к иллюстрации 4-16. Обратите внимание, что оба варда стоят между базой противника и лагерями лесных монстров в верхнем лесу. Какой бы лагерь не фармил игрок, он заранее узнает о приближении противников.
...
Иллюстрация 4-17 демонстрирует установку вардов при исполнении приёма pin and fog в нижнем лесу красной команды.

{caption: "Иллюстрация 4-17. Точки установки вардов в нижнему лесу", width: "100%"}
...
Когда игрок красной команды исполняет приём pin and fog, варды устанавливаются аналогично в верхнем или нижнему лесу синей команды. Точки для их установки симметричны относительно центра карты точкам на иллюстрациях 4-16 и 4-17.
...
#### 4.3.2.4 Взятие эпического монстра
...
#### 4.3.2.5 Дайв противника под башней
...
3. Push боковой линии, который продолжается приёмом pin и fog.

4. Приём pin и fog, когда команда берёт эпического монстра на другом конце карты.
...
Иллюстрация 4-20 демонстрирует второй сценарий штурма базы красной команды.
