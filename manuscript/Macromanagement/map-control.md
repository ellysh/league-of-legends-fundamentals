...
В этом разделе мы рассмотрим, как правильно отыгрывать мидгейм и лейтгейм. На этих стадиях ключевой задачей становится контроль карты. Именно эту задачу и пути её решения мы рассмотрим далее.

### 4.3.1 Позиционирование

>>>R2

В третьей главе мы рассмотрели позиционирование чемпиона на уровне микроменеджмента. Выполняя его, игрок учитывал ближайшие объекты и свои краткосрочные цели. Например, выбор выгодной позиции на линии зависит от положения и ресурсов оппонента, а так же состояния волны миньонов. Заняв эту позицию, игрок мог безопасно получать ресурсы.
...
На стадии мидгейма перед команда решает следующие задачи:
