...
Мы рассмотрели ряд типичных для мидгейма ротаций на карте. Каждая из них выполняется по алгоритму шаблону. Например, ротация треугольник. Её может выполнять игрок на любой линии. Главное — знать её шаги.
