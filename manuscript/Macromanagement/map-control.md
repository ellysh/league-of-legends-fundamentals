...
Мы рассмотрели ротацию треугольник и перенос давления на другую линию. Первая позволяет игроку присоединиться к командному действию. Вторая усиливает давление на противника. Теперь познакомимся с ротацией pin and fog. Она позволяет игроку получить больше ресурсов.
...
Ротация выполняется, когда разрушена вражеская Т1 башня на боковой линии. Это открывает игроку доступ в ближайший лес противников. Ротация состоит из двух основных шагов:

* **Первый шаг** называется **pin** (прикрепить). Игрок выполняет fast push и креш волны во вражескую Т2 башню на боковой линии. Это вынуждает одного из противников прийти к башне и фармить миньонов. В противном случае вражеская команда будет терять фарм. Таким образом оппонент оказывается привязан (pin) к своей башне на какое-то время.

* **Второй шаг** называется **fog** (затуманить). Игрок берёт под контроль вражеский лес: расставляет варды в ключевых точках. Дальше он может безопасно фармить лесные лагеря противника. Это вынуждает вражеского лесника прийти в этот лес, чтобы отбить свой фарм.

В результате этих действий игрок добьётся следующих результатов:

1. Выведет из очередного командного действия 1-2 противников.

2. Получит фарм на линии и во вражеском лесу.

3. Создаст давление на средней линии тем, что потенциально может устроить ганг.
...
**Второе действие** — игрок расставляет варды во вражеском лесу в двух точках, отмеченных номером 2. В нижних кустах ближе к средней линии ставится голубой или жёлтый вард. В верхних кустах — жёлтый вард или розовый. Последний здесь проще защитить, чем в нижних кустах.
...
Допустим, что противники реагируют на ротацию игрока pin and fog. Они смещаются к своей Т2 башне на верхней линии и в ближайший лес. Тогда команда игрока получает темп на очередном объекте. Если же противники не реагируют, игрок получает значительные ресурсы.
...
Иллюстрация 4-20 демонстрирует, как игрок синей команды устанавливает варды в нижнем лесу для исполнения ротации pin and fog.
...
Варды надо устанавливать максимально быстро. Самый оптимальный способ сделать это — пройти с нижней линии до точки под номером 1. Затем установить жёлтые варды через стенки влево (точка с номером 2) и вправо (точка с номером 3). Они перекроют подходы в лес с вражеской базы. Если у игрока есть голубой и розовый вард, он ставит голубой в точку 2 и розовый на перекрёстке в точке 4.
