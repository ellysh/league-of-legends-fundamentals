...
Мы говорили о сильных чемпионах для варианта OTP и быстрого поднятия рейтинга. При этом непонятно, что такое сильный чемпион? Остановимся на этом вопросе подробнее.
...
3. В игру добавили новые предметы.

4. Разработчики сделали глобальные правки баланса. Например, увеличили выживаемость всех чемпионов.

Все перечисленные изменения сильно меняют игру. Все последствия таких изменений сложно предугадать. Поэтому возникают проблемы с балансом. Игроки рано или поздно обнаруживают какой-то билд, который оказывается слишком силён по сравнению с альтернативами. Тогда разработчики пытаются решить обнаруженную проблему.

Большинство игроков охотно используют известные проблемы с балансом. Это даёт преимущество в краткосрочной перспективе. Проблема в том, что рано или поздно разработчики исправляют баланс. Тогда очень сильный чемпион или билд просто перестают работать.
...
Третий фактор — **минута игры**. Чемпионы для выхода в лейтгейм очень сильны, когда получают свои power spike. Например, Kayle на 16 уровне и одинаковых предметах выигрывает дуэль почти у любого чемпиона. Но 16 уровень она получает только после 20-й минуты игры.До этого Kayle относительно слаба и не может сражаться в одиночку. Поэтому её команда должна иметь средства, чтобы принимать сражения в начале партии.
