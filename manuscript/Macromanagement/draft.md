...
Мы познакомились с тремя стадиями партии: лейнинг, мидгейм и лейтгейм. На самом деле есть ещё одна стадия, которую мы не разобрали — это драфт. Её результат во многом определит ход партии. Это справедливо на любом уровне: от самого низкого ранга до соревновательных игр.

Рассмотрим пример. Допустим, что игроки красной команды контрпикнули большинство чемпионов синей команды. В таком случае говорят, что партия проиграна на этапе драфта. Красная команда уже получила серьёзное преимущество. Их противники должны приложить серьёзные усилия и совершить минимум ошибок просто, чтобы играть на равных.
...
Другой пример. Игрок на низком рейтинге часто проигрывает просто из-за плохих пиков и билдов. Если бы он выбирал других чемпионов, руны и покупал другие предметы, его процент побед был бы намного выше.

I> **Билд** или сборка (build) — это набор рун и строгий порядок покупки предметов, который игрок выбирает для своего чемпиона.

Драфт определяет билд. Эти два аспекта игры неразрывно связаны. Их оба мы рассмотрим в этом разделе. Также разберём типичные ошибки новичков при выборе чемпионов и билдов для них.
...
### 4.4.4.4 Предметы для класса Assassin
...
### 4.4.4.5 Предметы для класса Bruiser
