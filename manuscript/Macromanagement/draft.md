...
Мы рассмотрим основные принципы, по которым предметы выбираются в билд для конкретного чемпиона. Чтобы продемонстрировать эту систему, рассмотрим предметы патча 14.24 для чемпионов разных классов. Эти предметы в скором времени поменяются или будут удалены из игры. Но этот обзор поможет понять, как именно следует формировать билд и на что обращать внимание.

### 4.3.4.1 Предметы для AD Carry

>>>>

### 4.3.4.2 Предметы для AP Carry

### 4.3.4.3 Предметы для Tank

### 4.3.4.4 Предметы для Assassin
