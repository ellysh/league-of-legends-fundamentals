...
Таблица 4-11 демонстрирует предметы для класса Assassin.

{caption: "Таблица 4-11. Предметы для класса Assassin", width: "100%"}
...
Таблица 4-12 демонстрирует предметы для класса Bruiser.

{caption: "Таблица 4-12. Предметы для класса Bruiser", width: "100%"}
