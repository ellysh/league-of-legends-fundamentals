...
Такая классификация предметов только указывает на порядок их покупки. Она ничего не говорит о составлении правильного билда для чемпиона.

Опытные игроки пользуются альтернативной классификацией предметов. Она учитывает только собранные легендарные предметы и и ботинки (boots). Согласно ей, все легендарные предметы делятся на три категории:
...
2. **Транзитные** (transit) — никогда не покупаются первыми. Обычно это второй и третий предметы в билде. На поздних стадиях игры их эффективность уменьшается.

3. **Завершающие** (end items) — это обычно четвёртый и пятый предметы в билде. Они дают максимальный эффект на поздней стадии игры.
...
Самые распространённые начальные предметы на AD Carry следующие:
...
Допустим, чемпион игрока — это Yone. Он купил первым предметом BoRK. Его пассивный эффект наносит цели AD урон при каждой автоатаке. Этот урон равен 8% от текущего уровня здоровья цели. Теперь представим, что у противника 200 брони. Из-за этого физический урон (AD) по нему уменьшается на 66%. Когда Yone с BoRK станет атаковать цель с 200 брони, урон от эффекта предмета уменьшится с 8% до 2.6%. Это означает, что BoRK перестаёт работать.

Чтобы проблему низкого урона от эффекта BoRK, игроки на Melee AD Carry часто покупают Lord Dominik's Regards. Благодаря ему, чемпион игнорирует 35% брони цели, когда наносит любой AD урон. Таким образом броня цели из нашего примера уменьшается с 200 до 130. Тогда физический урон по ней уменьшается не на 66%, а на 56%. Следовательно, эффект от BoRK станет наносить на 2.6%, а 3.4% за каждый удар.
