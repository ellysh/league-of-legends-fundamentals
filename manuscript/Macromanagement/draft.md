...
4. **Trinity Force + Manamune**. Связка для AD carry с коротким временем перезарядки умений. Это позволяет реализовать урон эффекта spellblade от Trinity Force. Manamune усиливает урон от умений и даёт дополнительную ману, чтобы применять их чаще. В такой билд идут только Ezreal и Corki.
