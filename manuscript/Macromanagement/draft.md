...
**Индивидуальная синергия** означает, как чемпионы совместно решают свои задачи на стадии лейнинга. Они либо могут помогать друг другу, либо не могут.
...
У этой проблемы есть два решения. **Первое** — союзники на верхней и средней линии должны взять чемпионов с контролем. Например, Jax и Syndra. **Второе** — лесник выбирает чемпиона с контролем. Например, Jarvan. Тогда он не будет зависеть от пиков союзников. Очевидно, что в ранговых играх (solo queue) сработает только второе решение.
