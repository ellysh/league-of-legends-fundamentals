...
Приёмы управления волной тесно связаны с таймингом recall. Например, исполняя fast push, игрок заставляет противника оставаться на линии. Если оппонент делает recall, он допускает креш в свою башню и теряет ресурсы.

Игрокам на линии бывает трудно выбрать тайминг для recall. С одной стороны, возвращение на базу восстановит динамические ресурсы чемпиона. С другой стороны, путь с базы  на линию слишком длинный. Если оппонент будет фармить всё это время, он получит преимущество по золоту и предметам.

Чтобы правильно выбрать тайминг для recall, есть ряд общих правил. Следуя им, игрок платит за свое отсутствие на линии минимум ресурсов. Эти правила следующие:

1. **Recall выгодно делать, когда с обеих сторон подходит волна с осадным миньоном**. Такие волны умирают медленнее. Это означает, что у игрока есть больше времени на перемещение по карте.

2. **Если вражеская волна умирает быстро, игрок должен находиться на линии**. Обычно это происходит, когда волна союзных миньонов большая и двигает фронт в сторону противника.

3. **Если вражеская волна умирает медленно, игрок может уйти с линии**. Обычно это происходит, когда волна вражеских миньонов большая и двигает фронт в сторону игрока.

4. **Recall должен решать как можно больше задач**. Желательно сразу три: купить предмет, восстановить здоровье и ману. Если recall решает только одну задачу, в начале стадии лейнинга он невыгоден. Потери по опыту и золоту будут слишком большими.

Следуя этим правилам, надо учитывать действия противника. Если он поймёт, что игрок сделал recall, то может выполнить fast push и креш. Тогда игрок потеряет много ресурсов за своё отсутствие. Поэтому выгоднее скрывать свой recall от противника как можно дольше. Перед выполнением recall надо всегда выходить из области его видимости (например, прятаться в кустах).

Кроме четырёх общих правил для выбора recall, есть ряд факторов. Они влияют на состояние линии и карты в целом. Эти факторы следующие:
...
2. **Динамические ресурсы игрока** (здоровье, мана, готовые умения). Если они низкие, игрок не может влиять на карту. В этом случае recall будет выгодным.
...
5. **Тайминги ближайшего объекта**. Если рядом с линией скоро появится эпический монстр, игроку желательно оставаться на линии. Хороший recall делается за 1 минуту или 1:15 до появления объекта.
...
Recall во время приёма slow push требует пояснения. Игрок не может покинуть линию, потому что оппонент сделает freeze. Slow push должен закончиться fast push'ем и крешем. Только тогда игрок может делать recall.

Таблица 4-3 работает в обе стороны: на неё можно ориентироваться, когда противник выполняет какой-то приём управления волны.
...
8. **Помочь леснику забрать краба или эпического монстра**.
