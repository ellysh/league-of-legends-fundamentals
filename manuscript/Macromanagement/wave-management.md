...
Freeze выгоден не в любой ситуации. В некоторых случаях он даст противнику больше преимуществ, чем игроку.
...
3. **Когда оппонент имеет низкий потенциал для ганга**. В этом случае противнику невыгодно покидать линию и оказывать давление на карту.

4. **Игрок слабее оппонента, но может контролировать волну миньонов**. Freeze позволяет игроку безопасно получать ресурсы.

5. **Когда вражеский лесник рядом и готовит ганг**.

6. **Freeze может выполнить лесник, если его союзника нет на линии**. Так он может остановить креш вражеской волны.
...
Учитывайте текущую игровую ситуацию перед исполнением freeze.
