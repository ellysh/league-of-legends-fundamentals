...
{caption: "Иллюстрация 4-6. Возможности топлейнера, получившего приоритет", width: "100%"}
...
{caption: "Иллюстрация 4-7. Возможности мидлейнера, получившего приоритет", width: "100%"}
