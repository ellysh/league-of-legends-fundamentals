...
3. **Когда игра переходит в стадию мидгейма**. Freeze эффективен в начале партии, когда чемпионы ещё не получили 6-й уровень. После этого противник найдёт возможность реализовать приоритет, который даст ему freeze игрока.
