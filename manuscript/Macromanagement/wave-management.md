...
2. **Если оппонент допускает креш, появляется возможность для дайва**. Proxy farming отрезает противнику путь отступления, когда несколько союзников готовят дайв.
