...
Рассмотрим, как приём freeze меняет состояние игровых объектов и какие возможности открывает обеим сторонам на линии.
...
1. **Лесник игрока может устроить эффективный ганг**. Противник находится в опасной зоне, далеко от своей башни. Чтобы пережить ганг, ему придётся потратить flash.
...
4. **Навязать противнику all-in на раннем power spike**. Когда противник находится далеко от своей башни, дуэль, вероятно, закончится его убийством.

С другой стороны, freeze даёт оппоненту следующие возможности:

1. **Даёт темп и возможность уйти с линии**. За своё отсутствие противник потеряет минимум ресурсов.

2. **Вынуждает игрока оставаться на линии**. Он должен поддерживать freeze, если вражеская волна больше союзной. В противном случае произойдёт креш.
