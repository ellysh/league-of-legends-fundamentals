...
Второе место находится около вражеской базы. К нему опаснее и дольше идти. Но убийство волны там даёт игроку больше темпа — времени, которое он может отсутствовать на линии до того, как начнёт терять ресурсы. После фарма между Т2 и Т3 башнями игрок выполняет teleport, recall или execute.
...
Если игрок собирается получать ресурсы на линии только через proxy farming, обычно он выполняет следующие шаги:

1. Фармит одну волну между вражескими Т1 и Т2 башнями.

2. Выходит из зоны видимости.

3. Фармит следующую волну между вражескими Т2 и Т3 башнями.

4. Выполняет execute о вражескую Т3 башню.

Если у игрока хороший wave clear, на втором шаге он может забрать ближайший лагерь лесных монстров.

Есть и другие способы исполнения proxy farming. Например, игрок может постоянно фармить между T1 и Т2 башнями. Он выполняет execute только при приближении вражеского лесника или мидлейнера. Чтобы получить эту информацию, игрок заранее расставляет варды во вражеском лесу.
