...
Proxy farming работает не всегда. В определённых условиях лучше отказаться от этого приёма и фармить миньонов на середине линии.
...
5. **Когда у вражеской T1 башни низкий уровень здоровья**. Это вынудит оппонента выполнять pull и танковать миньонов.
...
3. **Когда оппонента имеет высокую мобильность или глобальное атакующее умение**. Это помешает игроку отступить или выполнить execute.
