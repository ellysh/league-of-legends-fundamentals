...
>>>
**Приоритет на линии** (lane priority) — это возможность игрока получить темп и его реализовать. Другими словами, это означает, может ли игрок покинуть свою линию прямо сейчас и при этом не сильно отстать от оппонента по ресурсам.
