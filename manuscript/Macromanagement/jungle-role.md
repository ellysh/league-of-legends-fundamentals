...
Фарм лагерей монстров остаётся важен и в мидгейме, но он отходит на второй план. Теперь игрок должен больше ориентироваться на командные действия, чем на стадии лейнинга. Разберём, что именно и как он должен делать.

#### 4.4.4.1 План

>>>R2

Первый раз, когда лесник делает recall после 14 минуты, он должен составить план. Этот план определит действия игрока для предстоящего выхода на карту.
...
Мы составили примерный план для выхода красного лесника на карту. Если Wukong сможет выполнить все его пункты, красная команда получит решающее преимущество. Тогда можно сказать, что она выиграла мидгейм.
