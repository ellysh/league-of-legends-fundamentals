...
3. **Ограничить длину игровых сессий**. Например, делать 15-30 минутные перерывы после каждых 2-3 партий.

4. **Ввести условия для прекращения игровой сессии**. Например, заканчивать игры после 3-х поражений подряд.
