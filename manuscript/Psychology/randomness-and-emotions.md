...
Рейтинг всё-равно представляет ценность, даже если игрок не собирается конвертировать его в деньги. Высокий рейтинг — это пропуск на участие в качественных партиях. Проблема в том, что на самом низком уровне Эло (железо и бронза) качество партий очень низкое. Это происходит по разным причинам:

* У участников высокая разница в уровне игры.

* Негативное поведение игроков.

* Отключения игроков во время партии.

* Слабые стратегии (например, выбор неподходящих для роли чемпионов).

На более высоком рейтинге эти факторы встречаются реже. Поэтому качество партий увеличивается.
