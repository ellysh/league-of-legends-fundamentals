...
{caption: "Иллюстрация 3-2. Временная диаграмма attack move", height: "50%"}
...
Если противник использует технику attack move, он получит такие же преимущества. Чтобы их скомпенсировать, игрок должен тоже применять attack move. В этом случае ни одна из сторон не получит преимуществ.
...
{caption: "Иллюстрация 3-4. Настройка 'Attack move on cursor'", height: "50%"}
![Настройка Attack move on cursor](images/Practice/options-attack-move-on-cursor.png)

Включите эту настройку. Теперь при нажатии клавиши A чемпион будет атаковать не ближайшую к нему цель, а ближайшую к курсору мыши. Без этой настройки вы не сможете выбирать правильную цель в командном сражении.
...
3. Когда чемпион перейдёт в анимацию firing или recovery, нажмите правую кнопку мыши. Чемпион начнёт двигаться в указанную точку карту.
